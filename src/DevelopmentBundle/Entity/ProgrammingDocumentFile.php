...
/**
 * ProgrammingDocumentFile
 *
 * @ORM\Table(name="programming_document_file")
 * @ORM\Entity(repositoryClass="DevelopmentBundle\Repository\ProgrammingDocumentFileRepository")
 */
class ProgrammingDocumentFile
{
    /**
     * @var int
     *
    ...
    /**
     * @ORM\OneToOne (targetEntity="ProgrammingDocument")
     * @ORM\JoinColumn(name="programming_document_id", referencedColumnName="id")
     */
    private $programmingDocument;
     ...
     * @return ProgrammingDocumentFile
     */
    public function setProgrammingDocument($programmingDocument)
    {
        $this->programmingDocument = $programmingDocument;
     ...
     */
    public function getProgrammingDocument()
    {
        return $this->programmingDocument;
    }
